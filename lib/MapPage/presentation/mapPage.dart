...
const API_KEY = constants.MAPS_API_KEY_ANDROID;
...
class _MapPage extends State<MapPage> {
  ...
  void markerFromTap(LatLng latlng) async {
    var result = await googlePlace.search.getNearBySearch(
        g_place.Location(lat: latlng.latitude, lng: latlng.longitude),
        POI_DISTANCE, type: 'point_of_interest');
    Marker resultMarker;
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == 'OK') {
          ...
          for (var step in steps) {
            ...
            List<LatLng> stepCoordinates = PolylinePoints().decodePolyline(
                polyline)
  ...
  void sendRouteInfo() {
    try {
      ...
      auth.sendRouteInfo(routeEmissions,
          transitDistance / 1000); //in liters and km, respectively
          ...
          children: [
              Padding(
                ...
                DropdownButton<String>(
                  ...
                  dropdownColor: const Color.fromRGBO(248, 237, 227, 1),
                            ...
                            Padding(
                              ...
                              child: ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                  ...
                                  minimumSize: const Size(160, 40), // Set the desired width and height
                                ),
