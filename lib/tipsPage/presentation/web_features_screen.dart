...
class WebFeaturesPage extends StatefulWidget {
  ...
  @override
  State<WebFeaturesPage> createState() => _WebFeaturesPage();
}

class _WebFeaturesPage extends State<WebFeaturesPage> {
  @override
              ...
              Container(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const WebAboutPage()),
                        );
                      }
                  )),
            ],
