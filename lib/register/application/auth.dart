...
class Authentication {
  ...
  static bool isUsernameCompliant(String username,{int minLength = 4 , int maxLength = 12}){
    if(username.isEmpty) {
      return false;
    }
    ...
    bool hasMaxLength = username.length < maxLength;

    return hasMaxLength & hasLowercase & hasMinLength;
  }
  ...
  static bool isEmailCompliant(String email){
    ...
    bool isValid = email.contains(RegExp(r"^[a-zA-Z0-9.a-zA-Z0-9.!#$%&'*+-/=?^_`{|}~]+@[a-zA-Z0-9]+.[a-zA-Z]+"));
  ...
  static Future<bool> registerUser(String username, String password, String email, String name, String age, String tipo) {
    ...
    return fetchAuthenticate(username, name, password, email, age, tipo);
  }
