...
class MobilitiesWaterDataPage extends StatefulWidget {

  const MobilitiesWaterDataPage({super.key});
  @override
  State<MobilitiesWaterDataPage> createState() => _MobilitiesWaterDataPage();
}

class _MobilitiesWaterDataPage extends State<MobilitiesWaterDataPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, String>> tips = [
      {
        'title': 'Water tips',
        'content': "1. Don't buy imported water.\n"
                                  ...
                                  child: Container(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        updateWaterStatistics(_selectedType, litersVal.text);
                                        _getWaterIndexText();
                                      },
                                    ),
                                  ),
                  ...
                  child: Center(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "What is the carbon footprint of a bottle of water?",                            style: GoogleFonts.getFont(
                              'Inter',
                              textStyle: const TextStyle(
                                color: Color.fromRGBO(82, 130, 103, 1.0),
                                fontSize: 26,
                          ...
                          Text(
                            ...
                            "of around 82.8g of carbon dioxide [1]. "
                            "Several studies indicate that the carbon footprint of tap water is lower than that of "
                            "bottled water, and can be up to 300 times lower [2][3].",
                            style: GoogleFonts.getFont(
                              'Inter',
                              textStyle: const TextStyle(
                          ...
                          Text(
                            "Although the consumption of bottled water leaves a significant carbon footprint,"
                                " it is entirely avoidable and, with some planning and willpower, you can "
                                "eliminate its contribution altogether. \nHowever, if for some reason you have to consume "
                                "bottled water, here are some questions you should be aware of: ",
                            style: GoogleFonts.getFont(
                              'Inter',
                              textStyle: const TextStyle(
                                color: Color.fromRGBO(0, 0, 0, 1.0),
                          ...
                          Text(
                            "[1] Blue, M.-L. (2 Mar. 2019). “What Is the Carbon Footprint of a Plastic Bottle?” . Sciencing, sciencing.com/carbon-footprint-plastic-bottle-12307187.html.\n\n "
                            "[2] Botto, S. Tap Water vs. Bottled Water in a Footprint Integrated Approach. Nat Prec (2009)\n\n"
                            "[3] Fantin, V., Masoni, P., and Scalbi, S. 2011. Tap Water or Bottled Water? A Review of LCA Studies Supporting a Campaign for Sustainable Consumption. Consultado em https://eplca.jrc.ec.europa.eu/ResourceDirectory/faces/studies/studyList.xhtml;jsessionid=5815FA62C22F7597BE89969C8292A83F\n\n",
                            style: GoogleFonts.getFont(
                              'Inter',
                              textStyle: const TextStyle(
                                color: Color.fromRGBO(0, 0, 0, 1.0),
