...
class UserStatisticsWaterPage extends StatefulWidget {
  final User user;

  UserStatisticsWaterPage({super.key, required this.user});
  @override
  State<UserStatisticsWaterPage> createState() => _UserStatisticsWaterPage();
}

class _UserStatisticsWaterPage extends State<UserStatisticsWaterPage> with SingleTickerProviderStateMixin {
