...
class UserStatisticsElectricityPage extends StatefulWidget {
  final User user;

   UserStatisticsElectricityPage({super.key, required this.user});
  @override
  State<UserStatisticsElectricityPage> createState() => _UserStatisticsElectricityPage();
}

class _UserStatisticsElectricityPage extends State<UserStatisticsElectricityPage> with SingleTickerProviderStateMixin {
