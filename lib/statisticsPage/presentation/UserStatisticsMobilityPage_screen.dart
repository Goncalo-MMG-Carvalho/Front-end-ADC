...
class UserStatisticsMobilityPage extends StatefulWidget {
  final User user;

   UserStatisticsMobilityPage({super.key, required this.user});
  @override
  State<UserStatisticsMobilityPage> createState() => _UserStatisticsMobilityPage();
}

class _UserStatisticsMobilityPage extends State<UserStatisticsMobilityPage> with SingleTickerProviderStateMixin {
