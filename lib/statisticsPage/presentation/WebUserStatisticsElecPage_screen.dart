...
import 'package:adc_handson_session/statisticsPage/presentation/UserStatisticsMobilityPage_screen.dart';
import 'package:adc_handson_session/statisticsPage/presentation/UserStatisticsWaterPage_screen.dart';
...
class WebUserStatisticsElectricityPage extends StatefulWidget {
  final User user;

  WebUserStatisticsElectricityPage({super.key, required this.user});
  @override
  State<WebUserStatisticsElectricityPage> createState() => _WebUserStatisticsElectricityPage();
}

class _WebUserStatisticsElectricityPage extends State<WebUserStatisticsElectricityPage> with SingleTickerProviderStateMixin {
                  ...
                  child: Center(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Electricity Consumption - ${user!.name}',
