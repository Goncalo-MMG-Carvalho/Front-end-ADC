...
class WebUserStatisticsFoodPage extends StatefulWidget {
  final User user;

   WebUserStatisticsFoodPage({super.key, required this.user});
  @override
  State<WebUserStatisticsFoodPage> createState() => _WebUserStatisticsFoodPage();
}

class _WebUserStatisticsFoodPage extends State<WebUserStatisticsFoodPage> with SingleTickerProviderStateMixin {
